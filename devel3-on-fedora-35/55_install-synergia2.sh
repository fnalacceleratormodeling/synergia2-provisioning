...
cmake -DCMAKE_INSTALL_PREFIX=${SYNINSTALL} \
  ...
  -DFFTW3_LIBRARIES=/usr/lib64/libfftw3.so \
  -DFFTW3_MPI_LIBRARIES=/usr/lib64/mpich/lib/libfftw3_mpi.so \
  -DFFTW3_OMP_LIBBRARIES=/usr/lib64/libfftw3_omp.so \
